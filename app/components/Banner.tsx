...
const Banner = () => {
  return (
    <div
      className="h-[85vh] w-full bg-cover bg-bottom bg-no-repeat"
    ...
    >
      ...
      <div className="relative z-10 flex flex-col justify-center items-center h-full px-4 text-center">
        ...
        <h1 className="xl:w-175 font-bold text-white xl:text-[70px] text-center mx-auto leading-tight xl:mb-10">Beautiful Plants For Your Interior</h1>
